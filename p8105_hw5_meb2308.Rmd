...
The following code chunks create a `city_state` variable and provide a table of the number of unresolved homicides and total number of homicides by city.

 ...
 * I used map to iterate over file names and read in data and saved each result as new variable in dataframe. 
...
output = map_dfr(read.csv, path, .id = "Input")

for (i in 1:20) {
    output[[i]] = read.csv(path_df$path[[i]])
}
